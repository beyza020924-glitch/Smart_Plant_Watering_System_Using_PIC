...
The system will monitor soil moisture levels using a sensor and activate a water pump automatically when the moisture level drops below a specified threshold.
